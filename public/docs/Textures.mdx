...
<NumberedList>
<NumberedItem>프래그먼트 셰이더를 수정해서, 웃는 얼굴(스마일) 만 반대 방향을 바라보도록 하세요: <LinkBlock url="https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/4.3.textures_exercise1/textures_exercise1.cpp" text="해답"/>.</NumberedItem>
